...
public class Activity3 extends AppCompatActivity {
    ...
    public void jButton1ActionPerformed(View v) {//GEN-FIRST:event_jButton1ActionPerformed
        long timestamp1 = System.currentTimeMillis();  //старт отсчёта времени исполнения
        //Считывение введённых значений
        ...
        //печать полученых значений
        printDoubleMatrix1(A, "A");
        printDoubleMatrix2(Z, "Z");
        long timestamp2 = System.currentTimeMillis();//конец отсчёта времени исполнения кода
        System.out.println("time elapsed: " + (timestamp2 - timestamp1)); //вывод в консоль
        TextView resText2 = (TextView) findViewById(R.id.result2);
        //вывод на экран отсчёта затраченого времени
    ...
    //Заполнение матрицы А значениями вверёнными в на устройстве
    ...
    //Заполнение матрицы Z значениями вверёнными в на устройстве
